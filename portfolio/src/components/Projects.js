  ...
  return (
    <section id="projects" className="projects-section">
      <h2 className="projects-heading">
        <span className="projects-number">01.</span> Selected Work
      </h2>
      ...
      <div className="project-card">
        ...
        <div className="project-content">
          <p className="project-label">Machine Learning</p>
      ...
      <div className="project-card">
        ...
        <div className="project-content">
          <p className="project-label">Medical XR</p>
      ...
      <div className="project-card">
        ...
        <div className="project-content">
          <p className="project-label">Research Project</p>
